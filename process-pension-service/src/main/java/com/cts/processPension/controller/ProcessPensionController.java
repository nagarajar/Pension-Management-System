...
public class ProcessPensionController {
	...
	public ResponseEntity<PensionDetail> getPensionDetails(@RequestHeader(name = "Authorization") String token,
		...
		return new ResponseEntity<PensionDetail>(processPensionService.getPensionDetails(pensionerInput), HttpStatus.OK);
	}
	...
	public ResponseEntity<ProcessPensionResponse> processPension(@RequestHeader(name = "Authorization") String token,
		...
		return new ResponseEntity<ProcessPensionResponse>(processPensionService.processPension(token, processPensionInput), HttpStatus.OK);
	}
